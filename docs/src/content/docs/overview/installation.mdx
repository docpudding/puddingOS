---
title: Installation
description: Installation guide for puddingOS.
---
...
{ ... }: let
    pos = builtins.fetchTarball {
        url = "https://github.com/docpudding/puddingOS/archive/release-25.11.tar.gz";
    };
...
```nix
{
    ...
    outputs = {
        ...
        nixosConfigurations.desktop = nixpkgs.lib.nixosSystem {
            system = "x86_64-linux";
            specialArgs = {inherit inputs pos;};
...
```sh
git clone https://github.com//puddingOS /path/to/pos
```
...
```sh
git clone https://github.com/docpudding/puddingOS /etc/nixos
